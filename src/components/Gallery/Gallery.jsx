    ...
    render() {
        ...
        const informs = this.info.map(info=>
            <Curvedimage visible={this.props.visible} src={require('./../../media/images/' + info.img_src)}
                         ...
                         position={info.position} material={"wireframe: true; transparent: true; opacity: 1.0;"}
                         ...
                         animation__smoth = {(this.props.visible) ? "property: rotation; from: " + "0 " + `${angle}` + " 0; to: 0 " +
                         `${(info.rotat) ? angle-360 : angle+360}`
                             + " 0; loop: true; dur: 80000; delay: 2000; easing: linear;" : "property: rotation; to: 0 0 0; dur: 2000; easing: linear;"}
           />
        );
        return(
            <Entity>
